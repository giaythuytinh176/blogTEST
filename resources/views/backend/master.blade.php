...
<!-- Mirrored from sb-admin-pro.startbootstrap.com/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 11 Mar 2021 08:47:52 GMT -->
<head>
    <meta charset="utf-8"/>
...
<nav class="topnav navbar navbar-expand shadow justify-content-between justify-content-sm-start navbar-light bg-white" id="sidenavAccordion">
    ...
    <ul class="navbar-nav align-items-center ml-auto">
        ...
        <li class="nav-item dropdown no-caret mr-3 mr-lg-0 dropdown-user">
            <a class="btn btn-icon btn-transparent-dark dropdown-toggle" id="navbarDropdownUserImage" href="javascript:void(0);" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img class="img-fluid" src="{{ asset('backend/assets/img/illustrations/profiles/profile-1.png') }}"/></a>
...
<script src="{{ asset('backend/assets/demo/date-range-picker-demo.js') }}"></script>
